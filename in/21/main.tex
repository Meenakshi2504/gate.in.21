...
\end{table}
 ...
 \begin{align}
     ...
     \angle H(j\omega)&=180-2\tan^{-1}{\frac{\omega}{\pi}}
 \end{align}
 Here , $\omega=\pi$
 \begin{align}
    \angle H(j\omega)\big|_{\omega=\pi} &= 90^\circ\\
    y(t)&=\sin(\pi t)=-\cos(\pi t +\frac{\pi}{2}) \label{eq:in.21.6} 
\end{align}
\begin{align}
    \cos(\omega t)&\system{H(j\omega)}|H(j\omega)|\cos(\omega t + \angle H(j\omega))\label{eq:in.21.7}
\end{align}
